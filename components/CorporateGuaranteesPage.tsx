...
import { Search, Filter, Download, ShieldCheck, CheckCircle2, AlertTriangle, Scale, Building2, Landmark, FileText, Plus, ChevronDown, Check, Eye, Trash2, DollarSign, Activity, Lock, RefreshCw, X, FileSignature } from 'lucide-react';
...
export const CorporateGuaranteesPage: React.FC = () => {
  // Mock Data
  ...
  const getStatusColor = (status: string) => {
      switch(status) {
          ...
          case 'Appraised': return 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400 border-blue-200 dark:border-blue-800';
          ...
          case 'Released': return 'bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-400 border-slate-200 dark:border-slate-700';
          case 'Expired': 
          case 'Claimed': return 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400 border-red-200 dark:border-red-800';
  ...
  const filteredAssets = selectedCompany.assets.filter(a => filterType === "All" || a.type === filterType);
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
            <ShieldCheck className="text-indigo-500" /> Guarantees & Collateral
          </h2>
          ...
          <div className="lg:col-span-2 flex flex-col gap-4 overflow-y-auto pr-2">
              ...
              {filteredAssets.length > 0 ? filteredAssets.map(asset => (
                  ...
                  <div className="text-center py-16 text-slate-400 border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-xl">
                      ...
                      <p className="font-medium">No collateral assets in the pool.</p>
                  </div>
              )}
              ...
              {selectedAsset ? (
                  <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-6 shadow-sm flex flex-col h-full animate-in slide-in-from-right duration-300">
                      <div className="flex justify-between items-start mb-6">
                          ...
                          <button onClick={() => setSelectedAsset(null)} className="md:hidden text-slate-400"><X size={20} /></button>
                      </div>
                      ...
                      <div className="space-y-6 flex-1">
                          ...
                          {/* Asset Analytics */}
                          <div className="h-56 relative bg-slate-50 dark:bg-slate-900/50 rounded-2xl border border-slate-100 dark:border-slate-800 p-4">
                              <p className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-4">Value Allocation</p>
                              ...
                              <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none pb-2">
                                  ...
                                  <span className="text-[10px] text-slate-500 uppercase font-medium">Pool</span>
                              </div>
                          </div>
                          ...
                          <div className="grid grid-cols-2 gap-4">
                              ...
                              <div className="p-3 bg-white dark:bg-slate-800 rounded-xl border border-slate-100 dark:border-slate-700">
                                  <p className="text-[10px] text-slate-400 uppercase font-bold mb-1">Margin Buffer</p>
                  ...
                  <div className="bg-slate-50 dark:bg-slate-900/30 rounded-2xl border border-dashed border-slate-200 dark:border-slate-700 p-8 flex flex-col items-center justify-center text-center h-full text-slate-400">
                      ...
                      <p className="font-medium">Select a collateral asset to view details</p>
                  </div>
              )}
          </div>
      </div>
